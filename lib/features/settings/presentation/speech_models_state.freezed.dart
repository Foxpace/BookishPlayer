...
mixin _$SpeechModelsState {
 ...
 SpeechModelsStatus get status; List<SpeechModel> get models; String get selectedModel; double? get downloadProgress; String? get statusMessage; String? get message;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(models),selectedModel,downloadProgress,statusMessage,message);

@override
String toString() {
  return 'SpeechModelsState(status: $status, models: $models, selectedModel: $selectedModel, downloadProgress: $downloadProgress, statusMessage: $statusMessage, message: $message)';
}
...
@useResult
$Res call({
 SpeechModelsStatus status, List<SpeechModel> models, String selectedModel, double? downloadProgress, String? statusMessage, String? message
});
...
/// Create a copy of SpeechModelsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? models = null,Object? selectedModel = null,Object? downloadProgress = freezed,Object? statusMessage = freezed,Object? message = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SpeechModelsStatus status,  List<SpeechModel> models,  String selectedModel,  double? downloadProgress,  String? statusMessage,  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SpeechModelsState() when $default != null:
return $default(_that.status,_that.models,_that.selectedModel,_that.downloadProgress,_that.statusMessage,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SpeechModelsStatus status,  List<SpeechModel> models,  String selectedModel,  double? downloadProgress,  String? statusMessage,  String? message)  $default,) {final _that = this;
switch (_that) {
case _SpeechModelsState():
return $default(_that.status,_that.models,_that.selectedModel,_that.downloadProgress,_that.statusMessage,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SpeechModelsStatus status,  List<SpeechModel> models,  String selectedModel,  double? downloadProgress,  String? statusMessage,  String? message)?  $default,) {final _that = this;
switch (_that) {
case _SpeechModelsState() when $default != null:
return $default(_that.status,_that.models,_that.selectedModel,_that.downloadProgress,_that.statusMessage,_that.message);case _:
  return null;
...
class _SpeechModelsState extends SpeechModelsState {
  const _SpeechModelsState({this.status = SpeechModelsStatus.initial, final  List<SpeechModel> models = const <SpeechModel>[], this.selectedModel = 'whisper-tiny', this.downloadProgress, this.statusMessage, this.message}): _models = models,super._();
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_models),selectedModel,downloadProgress,statusMessage,message);
...
/// Create a copy of SpeechModelsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? models = null,Object? selectedModel = null,Object? downloadProgress = freezed,Object? statusMessage = freezed,Object? message = freezed,}) {

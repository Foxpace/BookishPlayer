...
mixin _$NoteGalleryState {
 ...
 NoteGalleryStatus get status; List<BookMetadata> get metadata; List<BookNote> get notes; String? get message;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(metadata),const DeepCollectionEquality().hash(notes),message);

@override
String toString() {
  return 'NoteGalleryState(status: $status, metadata: $metadata, notes: $notes, message: $message)';
}
...
@useResult
$Res call({
 NoteGalleryStatus status, List<BookMetadata> metadata, List<BookNote> notes, String? message
});
...
/// Create a copy of NoteGalleryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? metadata = null,Object? notes = null,Object? message = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( NoteGalleryStatus status,  List<BookMetadata> metadata,  List<BookNote> notes,  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteGalleryState() when $default != null:
return $default(_that.status,_that.metadata,_that.notes,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( NoteGalleryStatus status,  List<BookMetadata> metadata,  List<BookNote> notes,  String? message)  $default,) {final _that = this;
switch (_that) {
case _NoteGalleryState():
return $default(_that.status,_that.metadata,_that.notes,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( NoteGalleryStatus status,  List<BookMetadata> metadata,  List<BookNote> notes,  String? message)?  $default,) {final _that = this;
switch (_that) {
case _NoteGalleryState() when $default != null:
return $default(_that.status,_that.metadata,_that.notes,_that.message);case _:
  return null;
...
class _NoteGalleryState implements NoteGalleryState {
  const _NoteGalleryState({this.status = NoteGalleryStatus.loading, final  List<BookMetadata> metadata = const <BookMetadata>[], final  List<BookNote> notes = const <BookNote>[], this.message}): _metadata = metadata,_notes = notes;
...
@override
int get hashCode => Object.hash(runtimeType,status,const DeepCollectionEquality().hash(_metadata),const DeepCollectionEquality().hash(_notes),message);
...
/// Create a copy of NoteGalleryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? metadata = null,Object? notes = null,Object? message = freezed,}) {

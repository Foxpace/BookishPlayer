...
class _BookNote implements BookNote {
  const _BookNote({required this.id, required this.positionMs, required this.text, required this.createdAt, required this.metadataId, this.kind = BookNoteKind.note, this.title, this.chapterTitle, this.endPositionMs});

...
mixin _$BookNote {
 ...
 String get id; String get bookId; int get positionMs; String get text; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,bookId,positionMs,text,createdAt);

@override
String toString() {
  return 'BookNote(id: $id, bookId: $bookId, positionMs: $positionMs, text: $text, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String bookId, int positionMs, String text, DateTime createdAt
});
...
/// Create a copy of BookNote
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? bookId = null,Object? positionMs = null,Object? text = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookNote() when $default != null:
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _BookNote():
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _BookNote() when $default != null:
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt);case _:
  return null;
...
class _BookNote implements BookNote {
  const _BookNote({required this.id, required this.bookId, required this.positionMs, required this.text, required this.createdAt});
...
/// Create a copy of BookNote
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? bookId = null,Object? positionMs = null,Object? text = null,Object? createdAt = null,}) {

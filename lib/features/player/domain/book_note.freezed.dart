...
mixin _$BookNote {
 ...
 String get id; String get bookId; int get positionMs; String get text; DateTime get createdAt; String? get chapterTitle; int? get endPositionMs;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,bookId,positionMs,text,createdAt,chapterTitle,endPositionMs);

@override
String toString() {
  return 'BookNote(id: $id, bookId: $bookId, positionMs: $positionMs, text: $text, createdAt: $createdAt, chapterTitle: $chapterTitle, endPositionMs: $endPositionMs)';
}
...
@useResult
$Res call({
 String id, String bookId, int positionMs, String text, DateTime createdAt, String? chapterTitle, int? endPositionMs
});
...
/// Create a copy of BookNote
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? bookId = null,Object? positionMs = null,Object? text = null,Object? createdAt = null,Object? chapterTitle = freezed,Object? endPositionMs = freezed,}) {
...
as DateTime,chapterTitle: freezed == chapterTitle ? _self.chapterTitle : chapterTitle // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt,  String? chapterTitle,  int? endPositionMs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookNote() when $default != null:
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt,_that.chapterTitle,_that.endPositionMs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt,  String? chapterTitle,  int? endPositionMs)  $default,) {final _that = this;
switch (_that) {
case _BookNote():
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt,_that.chapterTitle,_that.endPositionMs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String bookId,  int positionMs,  String text,  DateTime createdAt,  String? chapterTitle,  int? endPositionMs)?  $default,) {final _that = this;
switch (_that) {
case _BookNote() when $default != null:
return $default(_that.id,_that.bookId,_that.positionMs,_that.text,_that.createdAt,_that.chapterTitle,_that.endPositionMs);case _:
  return null;
...
class _BookNote implements BookNote {
  const _BookNote({required this.id, required this.bookId, required this.positionMs, required this.text, required this.createdAt, this.chapterTitle, this.endPositionMs});
...
/// Create a copy of BookNote
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? bookId = null,Object? positionMs = null,Object? text = null,Object? createdAt = null,Object? chapterTitle = freezed,Object? endPositionMs = freezed,}) {

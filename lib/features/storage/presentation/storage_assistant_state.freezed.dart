...
mixin _$StorageAssistantState {
 ...
 bool get loading; List<Audiobook> get books; StorageReport get report; String? get message;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StorageAssistantState&&(identical(other.loading, loading) || other.loading == loading)&&const DeepCollectionEquality().equals(other.books, books)&&(identical(other.report, report) || other.report == report)&&(identical(other.message, message) || other.message == message));
}


@override
int get hashCode => Object.hash(runtimeType,loading,const DeepCollectionEquality().hash(books),report,message);

@override
String toString() {
  return 'StorageAssistantState(loading: $loading, books: $books, report: $report, message: $message)';
}
...
@useResult
$Res call({
 bool loading, List<Audiobook> books, StorageReport report, String? message
});
...
/// Create a copy of StorageAssistantState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? loading = null,Object? books = null,Object? report = null,Object? message = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool loading,  List<Audiobook> books,  StorageReport report,  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StorageAssistantState() when $default != null:
return $default(_that.loading,_that.books,_that.report,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  List<Audiobook> books,  StorageReport report,  String? message)  $default,) {final _that = this;
switch (_that) {
case _StorageAssistantState():
return $default(_that.loading,_that.books,_that.report,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool loading,  List<Audiobook> books,  StorageReport report,  String? message)?  $default,) {final _that = this;
switch (_that) {
case _StorageAssistantState() when $default != null:
return $default(_that.loading,_that.books,_that.report,_that.message);case _:
  return null;
...
class _StorageAssistantState implements StorageAssistantState {
  const _StorageAssistantState({this.loading = true, final  List<Audiobook> books = const <Audiobook>[], this.report = const StorageReport(), this.message}): _books = books;
...
@override
int get hashCode => Object.hash(runtimeType,loading,const DeepCollectionEquality().hash(_books),report,message);
...
/// Create a copy of StorageAssistantState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loading = null,Object? books = null,Object? report = null,Object? message = freezed,}) {

...
void main() {
  ...
  group('Error containing private content and an absolute path', () {
    test('Given an error containing private content and an absolute path, When it is recorded locally, Then only sanitized bounded metadata is persisted', () async {
      // GIVEN
  ...
  group('More diagnostic failures than the local retention limit', () {
    test('Given more diagnostic failures than the local retention limit, When records are appended and then deleted, Then only the newest 200 remain and clear removes the file', () async {
      // WHEN

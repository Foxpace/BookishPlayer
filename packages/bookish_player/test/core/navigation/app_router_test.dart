...
void main() {
  group('App router', () {
    test('Given the app router, When its behavior is exercised, Then builds stable named locations for independent screens', () {
      // GIVEN
    ...
    test('Given the app router, When its behavior is exercised, Then hides the mini player on the full player route', () {
      // THEN

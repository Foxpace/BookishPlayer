...
void main() {
  group('Empty Sembast settings store', () {
    ...
    test('Given an empty Sembast settings store, When defaults are read, Then safe production defaults are returned', () async {
      // THEN
      expect(
    ...
    test('Given an empty Sembast settings store, When all preferences are persisted, Then typed values round-trip through the DAO', () async {
      // GIVEN
    ...
    test('Given an empty Sembast settings store, When an unknown legacy theme value is read, Then it migrates behaviorally to the system preference', () async {
      // WHEN

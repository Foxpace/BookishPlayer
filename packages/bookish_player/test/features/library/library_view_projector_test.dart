...
void main() {
  group('Books across every listening and metadata category', () {
    ...
    test('Given books across every listening and metadata category, When every filter and sort projection is requested, Then visible books follow typed criteria without mutating source state', () {
      // WHEN
    ...
    test('Given books across every listening and metadata category, When every cohesive grouping is requested, Then section titles remain typed and deterministic', () {
      // WHEN
      ...
      expect(series.sections.map((section) => section.title), contains('Saga'));

...
void main() {
  group('Sembast audiobook adapter', () {
    ...
    test('Given the Sembast audiobook adapter, When catalog, progress, notes, and replacement intents are sent, Then every domain port delegates to durable normalized storage', () async {
      // GIVEN

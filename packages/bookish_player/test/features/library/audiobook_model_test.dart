...
void main() {
  group('Audiobook model', () {
    test('Given the audiobook model, When its behavior is exercised, Then migrates legacy books and computes listening status', () {
      // WHEN
    ...
    test('Given the audiobook model, When its behavior is exercised, Then explicit shelf status and remaining time are honored', () {
      // WHEN
      final sut = Audiobook(
        id: 'planned',
        title: 'Planned Book',
    ...
    test('Given the audiobook model, When its behavior is exercised, Then a recorded completion marks the book as finished', () {
      // WHEN
      final sut = Audiobook(
        id: 'completed',
    ...
    test('Given the audiobook model, When its behavior is exercised, Then orders multi-file tracks by persisted order', () {
      // WHEN
      final sut = Audiobook(
        id: 'multi',
        title: 'Multi',

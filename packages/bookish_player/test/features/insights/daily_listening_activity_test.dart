...
void main() {
  group('Daily listening activity', () {
    test('Given the daily listening activity, When its behavior is exercised, Then aggregates sessions into bounded week, month, and year digests', () {
      // GIVEN
  ...
  group('Current listening streak', () {
    test('Given listening on consecutive days including today, When the streak is calculated, Then each distinct day is counted once', () {
      // GIVEN
      final now = DateTime(2026, 8, 6, 18);
      final sessions = [
        _session('today-1', DateTime(2026, 8, 6, 8), 10),
    ...
    test('Given consecutive listening ending yesterday, When the streak is calculated, Then the current streak remains active', () {
      // GIVEN
      final now = DateTime(2026, 8, 6, 18);
      final sessions = [
        _session('yesterday', DateTime(2026, 8, 5, 9), 15),
    ...
    test('Given listening stopped before yesterday, When the streak is calculated, Then the current streak is zero', () {
      // GIVEN
      final now = DateTime(2026, 8, 6, 18);
      final sessions = [
        _session('two-days-ago', DateTime(2026, 8, 4, 9), 10),

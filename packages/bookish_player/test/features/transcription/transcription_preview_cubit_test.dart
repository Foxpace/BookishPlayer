...
void main() {
  group('Transcription preview cubit', () {
    test('Given an edited transcription, When save and share is requested, Then the note is stored before the edited text is shared', () async {
      // GIVEN
      final calls = <String>[];
    ...
    test('Given an empty transcription, When save is requested, Then no note is stored', () async {
      // GIVEN
      var saveCalls = 0;
      final sut = TranscriptionPreviewCubit(
        draft: _draft,

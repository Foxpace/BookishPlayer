...
void main() {
  group('Iso bmff m4b chapter parser', () {
    test('Given the iso bmff m4b chapter parser, When its behavior is exercised, Then parses embedded chpl chapters without reading media payloads', () async {
      // GIVEN
      ...
      try {
        ...
        final bytes = _box('moov', _box('udta', _box('chpl', chapterPayload)));
    ...
    test('Given the iso bmff m4b chapter parser, When its behavior is exercised, Then ignores non-M4B files', () async {
      // THEN
      expect(
    ...
    test('Given the iso bmff m4b chapter parser, When its behavior is exercised, Then uses the custom ID3 CHAP fallback for MP3 chapters', () async {
      // GIVEN
      final temporary = await Directory.systemTemp.createTemp(
    ...
    test('Given the iso bmff m4b chapter parser, When its behavior is exercised, Then parses chapters from the real M4B sample', () async {
      // WHEN
      final sample = File(

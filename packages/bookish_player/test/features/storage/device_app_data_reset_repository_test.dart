...
void main() {
  group('Device app data reset repository', () {
    test(
      'Given the device app data reset repository, When its behavior is exercised, Then clearAppData removes every app store and managed file',
      () async {
        // GIVEN
        ...
        final model = File(
          p.join(documents.path, 'models', 'tiny', 'model.bin'),
        );

...
void main() {
  group('Just audio player repository', () {
    ...
    test('Given the just audio player repository, When its behavior is exercised, Then routes playback commands through the audio service handler', () async {
      // GIVEN
    ...
    test('Given the just audio player repository, When its behavior is exercised, Then duration probes always provide background audio metadata', () {
      // WHEN

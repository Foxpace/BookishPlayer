...
void main() {
  group('Audiobook metadata editor', () {
    ...
    test('Given an audiobook metadata editor, When metadata and chapters are edited, Then validated values and cohesive ordering are persisted', () async {
      // GIVEN
    ...
    test('Given an audiobook metadata editor, When a cover is replaced, Then the new cover is saved and the old imported cover is deleted', () async {
      // GIVEN
    ...
    test('Given an audiobook metadata editor, When loading or saving fails, Then typed revisioned failures are emitted and retry remains available', () async {
      // GIVEN

...
void registerPlayerCubitContinueListeningTests() {
  group('Continue listening', () {
    ...
    test('Given unfinished listened books, When continue listening is offered, Then only the most recently played book is offered once', () async {
      // GIVEN
      final older = _book(
        id: 'older',
        title: 'Older',
    ...
    test('Given a continue listening offer, When the user continues, Then the saved book opens and starts playing', () async {
      // GIVEN
      final book = _book(
        id: 'saved',
        title: 'Saved',

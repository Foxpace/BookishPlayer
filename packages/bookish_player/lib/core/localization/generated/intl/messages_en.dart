...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(buildNumber) => "Build ${buildNumber}";

  static String m1(version) => "Version ${version}";

  static String m2(chapter, position) => "${chapter} · ${position}";

  static String m3(title) => "Continue listening to ${title}?";

  static String m4(position) => "From ${position}";
  ...
  static String m10(duration) => "This moves ${duration} back.";

  static String m11(duration) => "This moves ${duration} forward.";

  static String m12(count) => "Last ${count} min";

  static String m13(count) => "Last ${count} sec";

  static String m14(size) => "${size} managed";

  static String m15(count) => "About ${count} minutes remaining";

  static String m16(count) => "${count} min";

  static String m17(size) => "${size} MB";

  static String m18(position) => "Note at ${position}";

  static String m19(count) =>
      "${Intl.plural(count, one: '1 note', other: '${count} notes')}";

  static String m20(title) => "Quote from ${title}";

  static String m21(start, end) => "${start} to ${end}";

  static String m22(start, end) => "${start} – ${end} in chapter";

  static String m23(size) => "${size} can be reclaimed safely";

  static String m24(title) => "Remove “${title}”?";

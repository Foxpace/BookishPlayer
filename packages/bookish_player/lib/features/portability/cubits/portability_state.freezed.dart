...
bool operator ==(Object other) {
  final _this = this as PortabilityState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PortabilityState&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.message, _this.message) || other.message == _this.message)&&(identical(other.effectRevision, _this.effectRevision) || other.effectRevision == _this.effectRevision));
}
...
int get hashCode {
  final _this = this as PortabilityState;
  return Object.hash(runtimeType,_this.status,_this.message,_this.effectRevision);
}

@override
String toString() {
  final _this = this as PortabilityState;
  return 'PortabilityState(status: ${_this.status}, message: ${_this.message}, effectRevision: ${_this.effectRevision})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,status,message,effectRevision);
}

...
bool operator ==(Object other) {
  final _this = this as QuoteTranscriptionState;
...
int get hashCode {
  final _this = this as QuoteTranscriptionState;
  return Object.hash(runtimeType,_this.status,_this.context,_this.range,_this.draft,_this.message,_this.effectRevision);
}

@override
String toString() {
  final _this = this as QuoteTranscriptionState;
  return 'QuoteTranscriptionState(status: ${_this.status}, context: ${_this.context}, range: ${_this.range}, draft: ${_this.draft}, message: ${_this.message}, effectRevision: ${_this.effectRevision})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? context = freezed,Object? range = freezed,Object? draft = freezed,Object? message = freezed,Object? effectRevision = null,}) {
  return _then(QuoteTranscriptionState(
...
@override
int get hashCode {
    return Object.hash(runtimeType,status,context,range,draft,message,effectRevision);
}

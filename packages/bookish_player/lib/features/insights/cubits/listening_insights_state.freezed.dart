...
mixin _$ListeningInsightsState {
 ...
 ListeningInsightsStatus get status; Map<InsightsPeriod, ListeningActivityRange> get activityByPeriod; InsightsPeriod get selectedPeriod; Duration get totalListening; int get completedBooks; int get activeDays; int get streakDays; AppMessage? get message; int get effectRevision;
...
@useResult
$Res call({
 ListeningInsightsStatus status, Map<InsightsPeriod, ListeningActivityRange> activityByPeriod, InsightsPeriod selectedPeriod, Duration totalListening, int completedBooks, int activeDays, int streakDays, AppMessage? message, int effectRevision
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ListeningInsightsStatus status,  Map<InsightsPeriod, ListeningActivityRange> activityByPeriod,  InsightsPeriod selectedPeriod,  Duration totalListening,  int completedBooks,  int activeDays,  int streakDays,  AppMessage? message,  int effectRevision)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListeningInsightsState() when $default != null:
return $default(_that.status,_that.activityByPeriod,_that.selectedPeriod,_that.totalListening,_that.completedBooks,_that.activeDays,_that.streakDays,_that.message,_that.effectRevision);case _:
  return orElse();
...
/// Create a copy of ListeningInsightsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? activityByPeriod = null,Object? selectedPeriod = null,Object? totalListening = null,Object? completedBooks = null,Object? activeDays = null,Object? streakDays = null,Object? message = freezed,Object? effectRevision = null,}) {

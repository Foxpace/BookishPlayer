...
mixin _$VoiceNoteState {
 ...
 VoiceNoteStatus get status; String get text; AppMessage? get message; int get effectRevision;
...
@useResult
$Res call({
 VoiceNoteStatus status, String text, AppMessage? message, int effectRevision
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VoiceNoteStatus status,  String text,  AppMessage? message,  int effectRevision)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VoiceNoteState() when $default != null:
return $default(_that.status,_that.text,_that.message,_that.effectRevision);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( VoiceNoteStatus status,  String text,  AppMessage? message,  int effectRevision)  $default,) {final _that = this;
switch (_that) {
case _VoiceNoteState():
return $default(_that.status,_that.text,_that.message,_that.effectRevision);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( VoiceNoteStatus status,  String text,  AppMessage? message,  int effectRevision)?  $default,) {final _that = this;
switch (_that) {
case _VoiceNoteState() when $default != null:
return $default(_that.status,_that.text,_that.message,_that.effectRevision);case _:
  return null;
...
class _VoiceNoteState implements VoiceNoteState {
  const _VoiceNoteState({this.status = VoiceNoteStatus.idle, this.text = '', this.message, this.effectRevision = 0});
...
/// Create a copy of VoiceNoteState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? text = null,Object? message = freezed,Object? effectRevision = null,}) {

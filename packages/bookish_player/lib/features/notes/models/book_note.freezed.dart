...
int get hashCode {
  final _this = this as BookNote;
  return Object.hash(runtimeType,_this.id,_this.positionMs,_this.text,_this.createdAt,_this.metadataId,_this.kind,_this.title,_this.chapterTitle,_this.endPositionMs);
}

@override
String toString() {
  final _this = this as BookNote;
  return 'BookNote(id: ${_this.id}, positionMs: ${_this.positionMs}, text: ${_this.text}, createdAt: ${_this.createdAt}, metadataId: ${_this.metadataId}, kind: ${_this.kind}, title: ${_this.title}, chapterTitle: ${_this.chapterTitle}, endPositionMs: ${_this.endPositionMs})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,positionMs,text,createdAt,metadataId,kind,title,chapterTitle,endPositionMs);
}

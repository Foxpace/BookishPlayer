...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlayerState&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.book, _this.book) || other.book == _this.book)&&(identical(other.position, _this.position) || other.position == _this.position)&&(identical(other.bufferedPosition, _this.bufferedPosition) || other.bufferedPosition == _this.bufferedPosition)&&(identical(other.duration, _this.duration) || other.duration == _this.duration)&&(identical(other.currentChapter, _this.currentChapter) || other.currentChapter == _this.currentChapter)&&(identical(other.currentChapterIndex, _this.currentChapterIndex) || other.currentChapterIndex == _this.currentChapterIndex)&&(identical(other.chapterCount, _this.chapterCount) || other.chapterCount == _this.chapterCount)&&(identical(other.chapterStart, _this.chapterStart) || other.chapterStart == _this.chapterStart)&&(identical(other.chapterPosition, _this.chapterPosition) || other.chapterPosition == _this.chapterPosition)&&(identical(other.chapterBufferedPosition, _this.chapterBufferedPosition) || other.chapterBufferedPosition == _this.chapterBufferedPosition)&&(identical(other.chapterDuration, _this.chapterDuration) || other.chapterDuration == _this.chapterDuration)&&const DeepCollectionEquality().equals(other.chapterTimeline, _this.chapterTimeline)&&(identical(other.isPlaying, _this.isPlaying) || other.isPlaying == _this.isPlaying)&&(identical(other.speed, _this.speed) || other.speed == _this.speed)&&(identical(other.playback, _this.playback) || other.playback == _this.playback)&&(identical(other.continueListeningChecked, _this.continueListeningChecked) || other.continueListeningChecked == _this.continueListeningChecked)&&(identical(other.continueListeningBook, _this.continueListeningBook) || other.continueListeningBook == _this.continueListeningBook)&&(identical(other.sleepTimerType, _this.sleepTimerType) || other.sleepTimerType == _this.sleepTimerType)&&(identical(other.sleepRemainingMinutes, _this.sleepRemainingMinutes) || other.sleepRemainingMinutes == _this.sleepRemainingMinutes)&&(identical(other.sleepChapterEndMs, _this.sleepChapterEndMs) || other.sleepChapterEndMs == _this.sleepChapterEndMs)&&const DeepCollectionEquality().equals(other.notes, _this.notes)&&(identical(other.message, _this.message) || other.message == _this.message)&&(identical(other.effectRevision, _this.effectRevision) || other.effectRevision == _this.effectRevision));
}
...
int get hashCode {
  final _this = this as PlayerState;
  return Object.hashAll([runtimeType,_this.status,_this.book,_this.position,_this.bufferedPosition,_this.duration,_this.currentChapter,_this.currentChapterIndex,_this.chapterCount,_this.chapterStart,_this.chapterPosition,_this.chapterBufferedPosition,_this.chapterDuration,const DeepCollectionEquality().hash(_this.chapterTimeline),_this.isPlaying,_this.speed,_this.playback,_this.continueListeningChecked,_this.continueListeningBook,_this.sleepTimerType,_this.sleepRemainingMinutes,_this.sleepChapterEndMs,const DeepCollectionEquality().hash(_this.notes),_this.message,_this.effectRevision]);
}

@override
String toString() {
  final _this = this as PlayerState;
  return 'PlayerState(status: ${_this.status}, book: ${_this.book}, position: ${_this.position}, bufferedPosition: ${_this.bufferedPosition}, duration: ${_this.duration}, currentChapter: ${_this.currentChapter}, currentChapterIndex: ${_this.currentChapterIndex}, chapterCount: ${_this.chapterCount}, chapterStart: ${_this.chapterStart}, chapterPosition: ${_this.chapterPosition}, chapterBufferedPosition: ${_this.chapterBufferedPosition}, chapterDuration: ${_this.chapterDuration}, chapterTimeline: ${_this.chapterTimeline}, isPlaying: ${_this.isPlaying}, speed: ${_this.speed}, playback: ${_this.playback}, continueListeningChecked: ${_this.continueListeningChecked}, continueListeningBook: ${_this.continueListeningBook}, sleepTimerType: ${_this.sleepTimerType}, sleepRemainingMinutes: ${_this.sleepRemainingMinutes}, sleepChapterEndMs: ${_this.sleepChapterEndMs}, notes: ${_this.notes}, message: ${_this.message}, effectRevision: ${_this.effectRevision})';
}
...
@useResult
$Res call({
 PlayerStatus status, Audiobook? book, Duration position, Duration bufferedPosition, Duration duration, AudioChapter? currentChapter, int currentChapterIndex, int chapterCount, Duration chapterStart, Duration chapterPosition, Duration chapterBufferedPosition, Duration chapterDuration, List<PlayerChapter> chapterTimeline, bool isPlaying, double speed, PlaybackPreferences playback, bool continueListeningChecked, Audiobook? continueListeningBook, SleepTimerType? sleepTimerType, int? sleepRemainingMinutes, int? sleepChapterEndMs, List<BookNote> notes, AppMessage? message, int effectRevision
});


$AudiobookCopyWith<$Res>? get book;$AudioChapterCopyWith<$Res>? get currentChapter;$PlaybackPreferencesCopyWith<$Res> get playback;$AudiobookCopyWith<$Res>? get continueListeningBook;
...
as PlaybackPreferences,continueListeningChecked: null == continueListeningChecked ? _self.continueListeningChecked : continueListeningChecked // ignore: cast_nullable_to_non_nullable
as bool,continueListeningBook: freezed == continueListeningBook ? _self.continueListeningBook : continueListeningBook // ignore: cast_nullable_to_non_nullable
as Audiobook?,sleepTimerType: freezed == sleepTimerType ? _self.sleepTimerType : sleepTimerType // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$AudiobookCopyWith<$Res>? get continueListeningBook {
    if (_self.continueListeningBook == null) {
    return null;
  }

  return $AudiobookCopyWith<$Res>(_self.continueListeningBook!, (value) {
    return _then(_self.copyWith(continueListeningBook: value));
  });
}
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PlayerStatus status,  Audiobook? book,  Duration position,  Duration bufferedPosition,  Duration duration,  AudioChapter? currentChapter,  int currentChapterIndex,  int chapterCount,  Duration chapterStart,  Duration chapterPosition,  Duration chapterBufferedPosition,  Duration chapterDuration,  List<PlayerChapter> chapterTimeline,  bool isPlaying,  double speed,  PlaybackPreferences playback,  bool continueListeningChecked,  Audiobook? continueListeningBook,  SleepTimerType? sleepTimerType,  int? sleepRemainingMinutes,  int? sleepChapterEndMs,  List<BookNote> notes,  AppMessage? message,  int effectRevision)  $default,) {final _that = this;
switch (_that) {
case _PlayerState():
return $default(_that.status,_that.book,_that.position,_that.bufferedPosition,_that.duration,_that.currentChapter,_that.currentChapterIndex,_that.chapterCount,_that.chapterStart,_that.chapterPosition,_that.chapterBufferedPosition,_that.chapterDuration,_that.chapterTimeline,_that.isPlaying,_that.speed,_that.playback,_that.continueListeningChecked,_that.continueListeningBook,_that.sleepTimerType,_that.sleepRemainingMinutes,_that.sleepChapterEndMs,_that.notes,_that.message,_that.effectRevision);case _:
  throw StateError('Unexpected subclass');
...
class _PlayerState implements PlayerState {
  const _PlayerState({this.status = PlayerStatus.idle, this.book, this.position = Duration.zero, this.bufferedPosition = Duration.zero, this.duration = Duration.zero, this.currentChapter, this.currentChapterIndex = 0, this.chapterCount = 0, this.chapterStart = Duration.zero, this.chapterPosition = Duration.zero, this.chapterBufferedPosition = Duration.zero, this.chapterDuration = Duration.zero,  List<PlayerChapter> chapterTimeline = const <PlayerChapter>[], this.isPlaying = false, this.speed = 1.0, this.playback = const PlaybackPreferences(), this.continueListeningChecked = false, this.continueListeningBook, this.sleepTimerType, this.sleepRemainingMinutes, this.sleepChapterEndMs,  List<BookNote> notes = const <BookNote>[], this.message, this.effectRevision = 0}): _chapterTimeline = chapterTimeline,_notes = notes;
...
@override@JsonKey() final  bool continueListeningChecked;
@override final  Audiobook? continueListeningBook;
...
@override $AudiobookCopyWith<$Res>? get book;@override $AudioChapterCopyWith<$Res>? get currentChapter;@override $PlaybackPreferencesCopyWith<$Res> get playback;@override $AudiobookCopyWith<$Res>? get continueListeningBook;

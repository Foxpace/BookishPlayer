...
bool operator ==(Object other) {
  final _this = this as DiagnosticsState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DiagnosticsState&&(identical(other.status, _this.status) || other.status == _this.status)&&(identical(other.message, _this.message) || other.message == _this.message)&&(identical(other.effectRevision, _this.effectRevision) || other.effectRevision == _this.effectRevision));
}
...
String toString() {
  final _this = this as DiagnosticsState;
  return 'DiagnosticsState(status: ${_this.status}, message: ${_this.message}, effectRevision: ${_this.effectRevision})';
}

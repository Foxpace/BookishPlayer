...
int get hashCode {
  final _this = this as SelectedAudioFile;
  return Object.hash(runtimeType,_this.sourcePath,_this.displayName,_this.sizeBytes);
}

@override
String toString() {
  final _this = this as SelectedAudioFile;
  return 'SelectedAudioFile(sourcePath: ${_this.sourcePath}, displayName: ${_this.displayName}, sizeBytes: ${_this.sizeBytes})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? sourcePath = null,Object? displayName = null,Object? sizeBytes = freezed,}) {
  return _then(SelectedAudioFile(
...
@override
int get hashCode {
    return Object.hash(runtimeType,sourcePath,displayName,sizeBytes);
}

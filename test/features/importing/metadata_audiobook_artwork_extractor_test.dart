...
void main() {
  group('Metadata audiobook artwork extractor', () {
    test(
      'Given the metadata audiobook artwork extractor, When its behavior is exercised, Then extracts embedded MP4/M4B cover artwork to durable storage',
      () async {
        // GIVEN
    ...
    test(
      'Given the metadata audiobook artwork extractor, When its behavior is exercised, Then extracts ID3 APIC cover artwork without a metadata plugin',
      () async {
        // GIVEN
        final temporary = await Directory.systemTemp.createTemp(
    ...
    test(
      'Given the metadata audiobook artwork extractor, When its behavior is exercised, Then extracts Opus comment cover artwork without a metadata plugin',
      () async {
        // GIVEN
        final temporary = await Directory.systemTemp.createTemp(

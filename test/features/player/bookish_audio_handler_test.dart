import 'package:bookish_player/features/player/data/bookish_audio_handler.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test('moves forward by 15 seconds across a chapter boundary', () {
  ...
  test('moves backward by 15 seconds across a chapter boundary', () {
    final target = relativeSeekTarget(
      durations: const [Duration(seconds: 20), Duration(seconds: 30)],
      currentIndex: 1,
  ...
  test('clamps notification seeks at the beginning and end', () {
    expect(
      relativeSeekTarget(
